...
Currently in graduate school, learning about sequential decision making under uncertainty, on my way to mathematically model intuition.

Feel free to connect with me for collaborations, opportunities, or just a chat! [linkedin](https://www.linkedin.com/in/kamalamsivakumar/) [Resume](https://kamalamsivakumar.github.io/resume/)  
Checkout my blog: [the_lotus_blog](https://kamalamsivakumar.github.io/) :smile:  

-------------------------------------------------------------------------------------------------------------------------------------------

### :clipboard: _technical_background_  
#### machine learning || deep learning || peerformance optimization || problem-solving  

### :chart_with_upwards_trend: _current_fields_of_interests_
#### mujoco/isaac sim || mechatronics || reinforcement learning
